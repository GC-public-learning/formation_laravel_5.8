...
### the goal : make the GET "customers/create" route for customers, modify the names of the CustomerController methods with conventional ways, define a personalized accessor for the status of customers
